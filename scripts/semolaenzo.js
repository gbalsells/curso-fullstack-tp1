...
let botonConfirmacion = document.getElementById("enviar");
botonConfirmacion.addEventListener("click", enviarDatos);
...
if (contacto.nombre === "" ||  contacto.telefono === "" ||  contacto.telefono === ""){
    ...
    console.log(`La persona que envio el mensaje se llama ${contacto.nombre} , su telefono ${contacto.telefono} y su mje fue ${contacto.mensaje}`);
}
}